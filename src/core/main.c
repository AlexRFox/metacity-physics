...
/* static void */
/* alex_window (gpointer spec, gpointer user_data) */
/* { */
...
/*   g_slist_foreach (display_windows, alex_window, NULL); */
...
main (int argc, char **argv)
{
  ...
  g_timeout_add (30, alex_windows_loop, NULL);
